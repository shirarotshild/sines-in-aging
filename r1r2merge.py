...
### MAIN ###
[in_fname1, in_fname2, out_fname] = sys.argv[1:]
def write_merged():
    ...
    with gene_lib.open_any(in_fname1, 'rt') as in_f1_handle:
        ...
        with gene_lib.open_any(in_fname2, 'rt') as in_f2_handle:
            ...
            with gzip.open(out_fname + '.tmp', 'wt', compresslevel=6) as out_handle:
                Bio.SeqIO.write(merged, handle=out_handle, format='fastq')
